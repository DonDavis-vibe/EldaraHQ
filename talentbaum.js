...
function renderTalentbaum() {
    ...
    // Regelpaket lädt gerade noch nach (kurz beim Start), oder der Bogen
    // wurde mit einem fremden Paket gespeichert, das es hier nicht gibt.
    if (!regeln) {
